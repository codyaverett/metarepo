...
echo "Testing Metarepo MCP Server for Claude Desktop compatibility..."

# Test 1: Initialize connection
echo "=== Test 1: Initialize Connection ==="
echo '{"jsonrpc":"2.0","id":1,"method":"initialize","params":{"protocolVersion":"2025-06-18","capabilities":{"roots":{"listChanged":true},"sampling":{}},"clientInfo":{"name":"claude-desktop","version":"0.9.0"}}}' | meta mcp serve
...
echo -e "\n=== Configuration Check ==="
echo "Claude Desktop config should point to: $(which meta)"
