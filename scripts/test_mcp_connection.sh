...
echo "Testing Metarepo MCP Server..."
echo ""
...
echo '{"jsonrpc":"2.0","id":1,"method":"initialize","params":{"protocolVersion":"2025-06-18","capabilities":{},"clientInfo":{"name":"test","version":"1.0"}}}' | \
    /Users/caavere/.cargo/bin/meta mcp serve 2>/dev/null | \
    jq -r '.result.name'
...
echo ""
echo "If you see 'metarepo-mcp-server', '13', and help output above, the server is working correctly."
echo ""
...
echo "  - 'Can you use the metarepo help tool?'"
echo "  - 'Show me the git status using metarepo'"
echo "  - 'List the available metarepo tools'"